...
export async function GET(request) {
  try {
    ...
    let products = [...(allProducts.cookware || [])];
    ...
    products = products.filter(product => {
      ...
      // Pieces filter
      if (pieces && product.pieces !== parseInt(pieces)) return false;
    ...
    const uniquePieces = [...new Set(products.map(p => p.pieces))];
    ...
    console.error('Get cookware error:', error);
